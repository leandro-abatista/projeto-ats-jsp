...
<head>
    <title>Sistema ATS</title>
      ...
      <meta name="description" content="Sistema jsp com bootstrap, jquery,  javascript, java, servlets" />
      <meta name="keywords" content="bootstrap, bootstrap admin template, admin theme, admin dashboard, dashboard template, admin template, responsive" />
      <meta name="author" content="Leandro Amorim" />
      <!-- Favicon icon -->
...
<%--       <link rel="stylesheet" type="text/css" href="<%= request.getContextPath() %>/resources/css/bootstrap.min.css"> --%>
      <link rel="stylesheet" type="text/css" href="<%= request.getContextPath() %>/resources/css/styles-cad-user.css">
  </head>
